    ...
    opts = {
      mappings = {
        n = {
          ...
          ["<Leader>tz"] = function() vscode.call "workbench.action.toggleZenMode" end,
          ["<Leader>tb"] = function() vscode.call "extension.toggleBool" end,
          ["<Leader>e"] = function() vscode.call "workbench.action.toggleSidebarVisibility" end,
          ["<Leader>o"] = function() vscode.call "workbench.action.focusSideBar" end,
          ["]t"] = "<CMD>Tabnext<CR>",
